...
\begin{figure}[H]
	\centering
	\captionsetup{justification=centering,margin=2cm}
	\includegraphics[width=\linewidth]{./images/motherboard.png} % mozno pouzit scale=0.5
	\centering
...
\begin{figure}[H]
	\centering
	\captionsetup{justification=centering,margin=2cm}
	\includegraphics[scale=0.3]{./images/cpu.png} % mozno pouzit width=\linewidth
	\centering
...
\begin{figure}[H]
	\centering
	\captionsetup{justification=centering,margin=2cm}
	\includegraphics[scale=0.1]{./images/ram.png} % mozno pouzit width=\linewidth
	\centering
